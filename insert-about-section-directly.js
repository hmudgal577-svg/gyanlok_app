...
<section class="about-section section bg-soft" id="about" aria-labelledby="about-heading" style="scroll-margin-top: 80px; padding: 4.5rem 0;">
  <div class="container">
    <div class="section-header fade-in" style="text-align:center; max-width:800px; margin:0 auto 2.5rem;">
      ...
      <h2 id="about-heading" style="font-size: clamp(1.8rem, 3vw, 2.4rem); font-weight:800;">Empowering Class 10 Students in Hindi</h2>
...
html = html.replace('<!-- """"""""""""""""""""""""""""""""""""""""\n     WHY GYANLOK', ABOUT_SECTION_HTML + '\n<!-- """"""""""""""""""""""""""""""""""""""""\n     WHY GYANLOK');

fs.writeFileSync('public/index.html', html, 'utf8');
console.log('✅ Inserted About Us Section (id="about") into index.html!');

// Bump version
html = html.replace(/script\.js\?v=[\d.]+/g, 'script.js?v=37.0.0');
html = html.replace(/style\.css\?v=[\d.]+/g, 'style.css?v=37.0.0');
fs.writeFileSync('public/index.html', html, 'utf8');
console.log('✅ Bumped version tag to v37.0.0');
