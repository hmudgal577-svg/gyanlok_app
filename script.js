          ...
          books: [
            {
              ...
              color: '#3A7BD5',
              chapters: [
                { num: 1,  title: 'साखी - कबीर', worksheets: 2 },
                { num: 2,  title: 'पद - मीरा', worksheets: 2 },
                { num: 3,  title: 'मनुष्यता - मैथिलीशरण गुप्त', worksheets: 2 },
                { num: 4,  title: 'पर्वत प्रदेश में पावस - सुमित्रानंदन पंत', worksheets: 2 },
                { num: 5,  title: 'तोप - वीरेन डंगवाल', worksheets: 2 },
                { num: 6,  title: 'कर चले हम फ़िदा - कैफ़ी आज़मी', worksheets: 2 },
                { num: 7,  title: 'आत्मत्राण - रवींद्रनाथ ठाकुर', worksheets: 2 },
                { num: 8,  title: 'बड़े भाई साहब - प्रेमचंद', worksheets: 2 },
                { num: 9,  title: 'डायरी का एक पन्ना - सीताराम सेकसरिया', worksheets: 2 },
                { num: 10, title: 'तताँरा-वामीरो कथा - लीलाधर मंडलोई', worksheets: 2 },
                { num: 11, title: 'तीसरी कसम के शिल्पकार शैलेंद्र - प्रहलाद अग्रवाल', worksheets: 2 },
                { num: 12, title: 'अब कहाँ दूसरे के दुख से दुखी होने वाले - निदा फ़ाज़ली', worksheets: 2 },
                { num: 13, title: 'पतझर में टूटी पत्तियाँ (गिन्नी का सोना / झेन की देन) - रवींद्र केलेकर', worksheets: 2 },
                { num: 14, title: 'कारतूस (एकांकी) - हबीब तनवीर', worksheets: 2 },
              ]
            },
            {
              name: 'संचयन (भाग-2)',
              ...
              color: '#2BA899',
              chapters: [
                { num: 1, title: 'हरिहर काका - मिथिलेश्वर', worksheets: 2 },
                { num: 2, title: 'सपनों के-से दिन - गुरदयाल सिंह', worksheets: 2 },
                { num: 3, title: 'टोपी शुक्ला - राही मासूम रज़ा', worksheets: 2 },
              ]
            }
          ]
        },
...
const WORKSHEET_FOLDERS = {
  CBSE: [
    { id: 'practice', name: 'Practice Worksheets', nameHi: 'अभ्यास पत्रक', icon: '📝', desc: 'हिंदी कोर्स-बी के संपूर्ण अभ्यास कार्य-पत्र' },
  ...
  ICSE: [
    { id: 'practice', name: 'Practice Worksheets', nameHi: 'अभ्यास पत्रक', icon: '📝', desc: 'ICSE हिंदी के संपूर्ण अभ्यास कार्य-पत्र' },
...
const TEST_DATA = {
  UTP: {
    CBSE: {
      10: [
        ...
        { id: 'UTP_CBSE_10_04', title: 'Unit Test Paper 4: Hindi (अभ्यास कार्य पत्र)', subject: 'Hindi', date: 'Aug 2026', pages: 4, color: '#E05555' },
      ],
      9: [], 8: [], 7: [], 6: []
    },
    ICSE: {
  ...
  Worksheets: {
    CBSE: {
      10: [
        { id: 'WS_CBSE_10_01', folder: 'practice', title: 'Worksheet 1: Hindi (अभ्यास कार्य-पत्र 1)', subtitle: 'कक्षा 10 हिंदी (कोर्स बी) | 30 अंक | 60 मिनट', subject: 'Hindi', marks: '30 Marks', date: 'Jan 2026', pages: 3, file_url: '/worksheets/Hindi_Practice_Worksheet_1_30Marks.docx', color: '#3A7BD5' },
        { id: 'WS_CBSE_10_02', folder: 'practice', title: 'Worksheet 2: Hindi (अभ्यास कार्य-पत्र 2)', subtitle: 'कक्षा 10 हिंदी (कोर्स बी) | 40 अंक | 90 मिनट', subject: 'Hindi', marks: '40 Marks', date: 'Feb 2026', pages: 4, file_url: '/worksheets/Hindi_Practice_Worksheet_2_40Marks.docx', color: '#2BA899' },
        { id: 'WS_CBSE_10_03', folder: 'practice', title: 'Worksheet 3: Hindi (अभ्यास कार्य-पत्र 3)', subtitle: 'कक्षा 10 हिंदी (कोर्स बी) | 30 अंक | 60 मिनट', subject: 'Hindi', marks: '30 Marks', date: 'Mar 2026', pages: 3, file_url: '/worksheets/Hindi_Practice_Worksheet_3_30Marks.docx', color: '#9B59B6' },
        { id: 'WS_CBSE_10_04', folder: 'practice', title: 'Worksheet 4: Hindi (अभ्यास कार्य-पत्र 4)', subtitle: 'कक्षा 10 हिंदी (कोर्स बी) | 40 अंक | 90 मिनट', subject: 'Hindi', marks: '40 Marks', date: 'Apr 2026', pages: 4, file_url: '/worksheets/Hindi_Practice_Worksheet_4_40Marks.docx', color: '#E05555' },
        // Muhavare Worksheets (Folder: muhavare)
        { id: 'WS_CBSE_10_MUH_01', folder: 'muhavare', title: 'Worksheet 1: मुहावरे (अभ्यास कार्य-पत्र 1)', subtitle: 'कक्षा 10 हिंदी (कोर्स बी) व्याकरण | 40 अंक | 60 मिनट', subject: 'Hindi Grammar', marks: '40 Marks', date: 'Sep 2026', pages: 3, file_url: '/worksheets/Muhavre_Worksheet_1_40Marks.docx', color: '#3A7BD5' },
        { id: 'WS_CBSE_10_MUH_01_ANS', folder: 'muhavare', title: 'Worksheet 1 उत्तर कुंजी: मुहावरे (Answer Key with Explanations)', subtitle: 'कक्षा 10 हिंदी व्याकरण | उत्तर कुंजी सहित स्पष्टीकरण', subject: 'Answer Key', marks: '40 Marks', date: 'Sep 2026', pages: 4, file_url: '/worksheets/Muhavre_Worksheet_1_Answer_Key.docx', color: '#10B981' },
        { id: 'WS_CBSE_10_MUH_02', folder: 'muhavare', title: 'Worksheet 2: मुहावरे (अभ्यास कार्य-पत्र 2)', subtitle: 'कक्षा 10 हिंदी (कोर्स बी) व्याकरण | 40 अंक | 60 मिनट', subject: 'Hindi Grammar', marks: '40 Marks', date: 'Sep 2026', pages: 3, file_url: '/worksheets/Muhavre_Worksheet_2_40Marks.docx', color: '#2BA899' },
        { id: 'WS_CBSE_10_MUH_02_ANS', folder: 'muhavare', title: 'Worksheet 2 उत्तर कुंजी: मुहावरे (Answer Key with Explanations)', subtitle: 'कक्षा 10 हिंदी व्याकरण | उत्तर कुंजी सहित स्पष्टीकरण', subject: 'Answer Key', marks: '40 Marks', date: 'Sep 2026', pages: 4, file_url: '/worksheets/Muhavre_Worksheet_2_Answer_Key.docx', color: '#10B981' },
        // Padbandh Worksheets (Folder: padbandh)
        { id: 'WS_CBSE_10_PAD_01', folder: 'padbandh', title: 'Worksheet 1: पदबंध (अभ्यास कार्य-पत्र 1)', subtitle: 'कक्षा 10 हिंदी (कोर्स बी) व्याकरण | 40 अंक | 60 मिनट', subject: 'Hindi Grammar', marks: '40 Marks', date: 'Sep 2026', pages: 4, file_url: '/worksheets/Padbandh_Worksheet_1_40Marks.docx', color: '#8B5CF6' },
        { id: 'WS_CBSE_10_PAD_02', folder: 'padbandh', title: 'Worksheet 2: पदबंध (अभ्यास कार्य-पत्र 2)', subtitle: 'कक्षा 10 हिंदी (कोर्स बी) व्याकरण | 40 अंक | 60 मिनट', subject: 'Hindi Grammar', marks: '40 Marks', date: 'Sep 2026', pages: 4, file_url: '/worksheets/Padbandh_Worksheet_2_40Marks.docx', color: '#EC4899' },
      ],
      9: [], 8: [], 7: [], 6: []
    },
    ICSE: {
      10: [
        { id: 'WS_ICSE_10_01', folder: 'practice', title: 'Worksheet 1: ICSE Hindi (अभ्यास कार्य-पत्र 1)', subtitle: 'कक्षा 10 ICSE हिंदी | 40 अंक | 90 मिनट', subject: 'Hindi', marks: '40 Marks', date: 'Jan 2026', pages: 3, file_url: '/worksheets/ICSE_Hindi_Practice_Worksheet_1_40Marks.docx', color: '#3A7BD5' },
        { id: 'WS_ICSE_10_02', folder: 'practice', title: 'Worksheet 2: ICSE Hindi (अभ्यास कार्य-पत्र 2)', subtitle: 'कक्षा 10 ICSE हिंदी | 40 अंक | 90 मिनट', subject: 'Hindi', marks: '40 Marks', date: 'Feb 2026', pages: 3, file_url: '/worksheets/ICSE_Hindi_Practice_Worksheet_2_40Marks.docx', color: '#2BA899' },
        // Muhavare Worksheets (Folder: muhavare)
...
function initNavbar() {
  ...
  if (hamburger && navLinks && !hamburger.dataset.navBound) {
    ...
    hamburger._toggleMenu = toggleMenu;
  ...
  /* Close dropdown/nav on outside click — attach only once */
  if (!document._navOutsideClickBound) {
    ...
    document.addEventListener('click', (e) => {
      ...
      if (_nav && _navLinks && _ham && !_nav.contains(e.target)) {
...
async function openWorksheetViewer(id, title, fileUrl) {
  ...
  overlay.innerHTML = `
    <div class="fs-header">
      <div style="display:flex; align-items:center; gap:0.5rem; min-width:0; flex:1;">
        ...
        <div class="fs-breadcrumb" style="overflow:hidden; text-overflow:ellipsis; white-space:nowrap;">
          <span class="fs-bc-title" style="font-weight:700;">${title}</span>
        </div>
      </div>
  ...
  try {
    ...
    console.error('Error loading worksheet content:', err);
    docBody.innerHTML = `
      <div class="fs-empty">
        <div style="font-size:3.5rem;margin-bottom:1rem">📄</div>
        <h3>${title}</h3>
