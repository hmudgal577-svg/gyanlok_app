...
def get_navbar(active_link=''):
  ...
  <div class="container nav-inner">
    ...
    <nav class="nav-links" id="nav-links" role="navigation" aria-label="Main navigation">
      ...
      <a href="/cbse/class-10/hindi/" class="nav-link {'active' if active_link=='cbse' else ''}">CBSE Class 10</a>
      <a href="/icse/class-10/hindi/" class="nav-link {'active' if active_link=='icse' else ''}">ICSE Class 10</a>
      <a href="/worksheets/" class="nav-link {'active' if active_link=='worksheets' else ''}">Worksheets</a>
      <a href="/hindi-grammar/" class="nav-link {'active' if active_link=='grammar' else ''}">Hindi Grammar</a>
      <a href="/pyq/" class="nav-link {'active' if active_link=='pyq' else ''}">PYQs</a>
